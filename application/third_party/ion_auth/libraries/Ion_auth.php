...
//		date_default_timezone_set('Asia/Jakarta');
	...
	public function is_operator($id = FALSE)
	{
		...
		return $this->ion_auth_model->in_group($operator_group, $id);
	}

	/**
	 * @param int|string|bool $id
	 *
	 * @return bool Whether the user is an ppic
	 * @author Dzaki Fauzaan
	 */
	public function is_ppic($id = FALSE)
	{
		$this->ion_auth_model->trigger_events('is_ppic');

		$ppic_group = $this->config->item('ppic_group', 'ion_auth');

		return $this->ion_auth_model->in_group($ppic_group, $id);
	}
