...
$config['tables']['users']           = 'prd_msusers';
$config['tables']['groups']          = 'prd_msgroups';
$config['tables']['users_groups']    = 'prd_users_groups';
$config['tables']['login_attempts']  = 'prd_mslogin_attempts';
//
/*
...
$config['operator_group']			  = 'operator';         // Group Operator
$config['admin_group']                = 'admin';             // Default administrators group, use name
...
$config['user_expire']                = 604800;//seven days               // How long to remember the user (seconds). Set to zero for no expiration - see sess_expiration in CodeIgniter Session Config for session expiration
...
$config['email_config'] = array(
	...
	'smtp_user' => 'animename00@gmail.com',  // Email gmail
	'smtp_pass'   => 'ketikaja',  // Password gmail
	'smtp_port'   => 465,
	'mailtype'  => 'html',
	'newline'  => "\r\n"
);
...
$config['message_start_delimiter'] = '<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="material-icons">close</i></button>'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="material-icons">close</i></button>';		// Error message start delimiter
