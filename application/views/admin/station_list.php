						...
						<?php if (!empty_object($stations)): ?>
							...
							<div class="toolbar">
								<div class="places-buttons">
									<div class="row">
										<div class="col-md-12">
											<a href="<?= base_url('production/station/add') ?>" class="btn btn-primary btn-round" onclick="clickAndDisable(this);">
							...
							<div class="material-datatables">
								...
								<table id="datatables" class="table table-striped table-no-bordered table-hover"
									...
									<?php foreach ($stations as $station): ?>
										<tr>
											<td><?php echo htmlspecialchars($station->no, ENT_QUOTES, 'UTF-8'); ?></td>
											<td><?php echo htmlspecialchars($station->sta_name, ENT_QUOTES, 'UTF-8'); ?></td>
											<td><?php echo htmlspecialchars($station->sta_type, ENT_QUOTES, 'UTF-8'); ?></td>

											<td><?= '<i>' . htmlspecialchars(is_null_modiby($station->sta_modiby), ENT_QUOTES, 'UTF-8') . '<i>'; ?></td>
											<td><?= '<i>' . htmlspecialchars(is_null_modiby($station->sta_modidate, TRUE), ENT_QUOTES, 'UTF-8') . '</i>'; ?></td>
											<td>
												<?= print_beauty_status($station->sta_is_deleted) ?>
											</td>
											<td class="text-right">
							...
							<div class="places-buttons">
								...
								<div class="row">
									<div class="col-md-6 col-md-offset-3">
										<div style="text-align: center;">
											<a href="<?= base_url('production/station/add') ?>" class="btn btn-primary btn-round btn-block">
												<i class="material-icons">add</i>
												<b>Add Data</b>
											</a>
										</div>
