						...
						<div class="row">
							<div class="col-md-12">
								...
								<div class="card-footer">
									...
									<?php echo form_submit('submit', lang('login_submit_btn'), "class='btn btn-primary btn-round btn-block'"); ?>
								</div>
								<div class="card-footer">
									<p>
										<a href="<?= base_url('production/forgot_password') ?>"><?php echo lang('login_forgot_password'); ?></a>
									</p>
								</div>
